    ...
    public partial class EditQuestionSet : ActionHandler
    {
        ...
        internal void SaveNewData()
        {
            ...
            DataWrapper = new DataWrapper
            {
                ...
                TargetFileStream = ActionHandlerInstance.ResolveTargetFileStream(comboBox1.SelectedItem + ".xml")
            };
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DataWrapper.TargetFileStream = ActionHandlerInstance.ResolveTargetFileStream(comboBox1.SelectedItem + ".xml");
