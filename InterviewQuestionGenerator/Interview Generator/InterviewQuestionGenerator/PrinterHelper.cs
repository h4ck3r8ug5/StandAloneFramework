...
{
    public class PrinterHelper : PrintDocument
    {
        ...
        /// <remarks></remarks>
        public PrinterHelper(string str)
        {
            //Set the file stream
        ...
        protected override void OnPrintPage(PrintPageEventArgs e)
        {
            ...
            {
                printHeight = base.DefaultPageSettings.PaperSize.Height - base.DefaultPageSettings.Margins.Top -
                              base.DefaultPageSettings.Margins.Bottom;
                printWidth = base.DefaultPageSettings.PaperSize.Width - base.DefaultPageSettings.Margins.Left -
            ...
            Int32 numLines = printHeight/PrinterFont.Height;
            ...
            e.Graphics.MeasureString(_text.Substring(RemoveZeros(curChar)), PrinterFont,
